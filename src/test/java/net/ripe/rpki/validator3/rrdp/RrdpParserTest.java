...
public class RrdpParserTest {
    ...
    public void should_parse_notification() throws Exception {
        final Notification notification = new RrdpParser().notification(file("rrdp/notification1.xml"));
        assertEquals("9df4b597-af9e-4dca-bdda-719cce2c4e28", notification.sessionId);
        assertEquals("http://repo.net/repo/snapshot.xml", notification.snapshotUrl);
